...
namespace MojoUi
{
    ...
    public static class MojoExtensions
    {
        ...
        /// property on a MojoObject, using CallerMemberName to raise the notification
        /// and the ref to the backing field to set the property.
        /// </summary>
        /// <typeparam name="TObj">The type of the This.</typeparam>
        /// <typeparam name="TRet">The type of the return value.</typeparam>
        /// <param name="This">The <see cref="IMojoObject"/> raising the notification.</param>
        ...
        public static TRet RaiseAndSetIfChanged<TObj, TRet>(
            ...
            TRet newValue,
            [CallerMemberName] string propertyName = null) where TObj : IMojoObject
        {
